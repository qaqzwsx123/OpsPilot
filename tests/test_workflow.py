...
class WorkflowTests(unittest.TestCase):
    ...
    def test_audit_event_can_be_deleted_with_deletion_trail(self) -> None:
        write_audit("test-audit-delete", "deletion_target", {"case": "confirm_delete"})
        target = next(item for item in list_audit(limit=30) if item["action"] == "deletion_target")
